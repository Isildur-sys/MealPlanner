...
public class GoalsFrame extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        NewJFrame.pref.put("calories", jTextField1.getText());
        NewJFrame.pref.put("carbs", jTextField2.getText());
        NewJFrame.pref.put("fats", jTextField3.getText());
        NewJFrame.pref.put("protein", jTextField4.getText());
